...
#'
#' @note Logger class used internally by \pkg{renatR}
#'
renatRLogger <-  R6Class("renatRLogger",
  public = list(
    ...
    #' @description initialize the \pkg{renatR} logger
